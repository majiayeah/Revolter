    ...
    <div>
        ...
        <xm-container>
            ...
            <md-input-container :class="classes.portInput">
                <label>本地端口</label>
                <md-input v-model="port" type="number" min="1024" max="65535" :disabled="running"></md-input>
            ...
            <xm-switch v-model="allowLAN" :disabled="running">允许来自局域网的链接</xm-switch>
        ...
        <md-button class="md-fab md-fab-bottom-right" @click="toggleServer" :disabled="preparing">
            <md-icon>{{!running ? "play_arrow" : "stop"}}</md-icon>
...
export default {
    ...
    data() {
        ...
        return ({
            ...
            running: false,
            preparing: !this.$root.serverInited,
            listeningPort: null,
            classes: {
                portInput: "",
                remoteHostInput: "",
    ...
    methods: {
        ...
        async startServer() {
            ...
            this.server.start(this.listeningPort, this.allowLAN)
